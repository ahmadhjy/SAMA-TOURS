...
MESSAGES = {
    ...
    'Chat on WhatsApp': ('تواصل معنا عبر واتساب', 'Discuter sur WhatsApp'),
    ...
    'Expert Travel Agents': ('خبراء سفر محترفون', 'Agents de voyage experts'),
    'Personal planning for every trip': ('تخطيط شخصي لكل رحلة', 'Planification personnalisée pour chaque voyage'),
    'Book via WhatsApp': ('الحجز عبر واتساب', 'Réserver via WhatsApp'),
    'Fast quotes & easy booking': ('عروض أسعار سريعة وحجز سهل', 'Devis rapides et réservation facile'),
    ...
    'Your journey starts here': ('انطلق في رحلتك من هنا', 'Votre voyage commence ici'),
    'Explore the World with Sama Tours': ('سافر إلى العالم مع سما تورز', 'Explorez le monde avec Sama Tours'),
    'Book packages, plan custom trips, and get visa support — all with experienced travel experts by your side.': (
        'احجز باقاتك، خطّط لرحلات مخصّصة، واستفد من خدمات التأشيرات مع فريق خبراء السفر لدينا.',
    ...
    'Travel deals & inspiration': ('عروض سفر ملهمة', 'Offres et inspiration voyage'),
    'Handpicked offers to help you plan your next getaway': (
        'عروض منتقاة بعناية لتخطيط عطلتك القادمة',
    ...
    'Beach & Sun Escapes': ('عطلات الشاطئ والشمس', 'Évasions plage et soleil'),
    'Caribbean, Maldives & more — relax by the sea': (
        'الكاريبي، المالديف والمزيد — استمتع بإجازة على البحر',
    ...
    'The Sama Tours promise': ('وعدنا لكم في سما تورز', 'La promesse Sama Tours'),
    'Everything you need for a worry-free holiday — from one trusted team': (
        'كل ما تحتاجه لعطلة مريحة وآمنة — مع فريق واحد تثق به',
    ...
    "Our customers' feedback is essential in building a great reputation and maintaining excellent service. By listening to our customers' needs, we improve our offerings and provide an exceptional travel experience.": (
        'آراء عملائنا تساعدنا على تقديم خدمة أفضل وتجربة سفر استثنائية. نستمع لاحتياجاتكم ونطوّر عروضنا باستمرار.',
