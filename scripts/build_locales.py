...
MESSAGES = {
    ...
    'Visa Requirements': ('متطلبات التأشيرة', 'Exigences de visa'),
    'Contact Us': ('اتصل بنا', 'Contactez-nous'),
    ...
    'Mon – Sun, 9:00 – 18:00': ('الإثنين – الأحد، 9:00 – 18:00', 'Lun – Dim, 9h00 – 18h00'),
    'WhatsApp': ('واتساب', 'WhatsApp'),
    'Travel beyond your imagination, with Sama Tours!': (
        'سافر إلى ما وراء خيالك مع سما تورز!',
        'Voyagez au-delà de votre imagination avec Sama Tours !',
    ),
    'Chat on WhatsApp': ('تحدث عبر واتساب', 'Discuter sur WhatsApp'),
    'Quick Links': ('روابط سريعة', 'Liens rapides'),
    'Follow Us': ('تابعنا', 'Suivez-nous'),
    ...
    'Expert Travel Agents': ('وكلاء سفر خبراء', 'Agents de voyage experts'),
    'Personal planning for every trip': ('تخطيط شخصي لكل رحلة', 'Planification personnalisée pour chaque voyage'),
    'Book via WhatsApp': ('احجز عبر واتساب', 'Réserver via WhatsApp'),
    'Fast quotes & easy booking': ('عروض سريعة وحجز سهل', 'Devis rapides et réservation facile'),
    'Visa Services': ('خدمات التأشيرة', 'Services de visa'),
    'Requirements & documentation': ('المتطلبات والوثائق', 'Exigences et documentation'),
    'Affordable Packages': ('باقات بأسعار مناسبة', 'Forfaits abordables'),
    'Dream vacations within budget': ('عطلات أحلام ضمن ميزانيتك', 'Vacances de rêve dans votre budget'),
    'View details': ('عرض التفاصيل', 'Voir les détails'),
    'Book Now': ('احجز الآن', 'Réserver'),
    'Find your perfect trip': ('اعثر على رحلتك المثالية', 'Trouvez votre voyage idéal'),
    ...
    'Your journey starts here': ('رحلتك تبدأ هنا', 'Votre voyage commence ici'),
    'Explore the World with Sama Tours': ('استكشف العالم مع سما تورز', 'Explorez le monde avec Sama Tours'),
    'Book packages, plan custom trips, and get visa support — all with experienced travel experts by your side.': (
        'احجز الباقات، خطط رحلات مخصصة، واحصل على دعم التأشيرة — مع خبراء سفر بجانبك.',
    ...
    'Get a Quote': ('احصل على عرض سعر', 'Demander un devis'),
    'Travel deals & inspiration': ('عروض سفر وإلهام', 'Offres et inspiration voyage'),
    'Handpicked offers to help you plan your next getaway': (
        'عروض مختارة لمساعدتك في التخطيط لعطلتك القادمة',
        'Offres sélectionnées pour planifier votre prochaine escapade',
    ),
    'View all packages': ('عرض كل الباقات', 'Voir tous les forfaits'),
    'Popular': ('شائع', 'Populaire'),
    'Beach & Sun Escapes': ('هروب إلى الشاطئ والشمس', 'Évasions plage et soleil'),
    'Caribbean, Maldives & more — relax by the sea': (
        'الكاريبي، المالديف والمزيد — استرخِ بجانب البحر',
        'Caraïbes, Maldives et plus — détente au bord de la mer',
    ),
    'Discover deals': ('اكتشف العروض', 'Découvrir les offres'),
    'City breaks': ('عطلات المدينة', 'City breaks'),
    'Europe & Beyond': ('أوروبا وما بعدها', 'Europe et au-delà'),
    'Paris, Dubai, Istanbul & iconic destinations': (
        'باريس، دبي، إسطنبول ووجهات أيقونية',
        'Paris, Dubaï, Istanbul et destinations emblématiques',
    ),
    'Country guides & PDF documents in one place': (
        'أدلة الدول وملفات PDF في مكان واحد',
    ...
    'Everyone deserves their dream vacation — browse and book on WhatsApp': (
        'الجميع يستحق عطلتهم المثالية — تصفح واحجز عبر واتساب',
    ...
    'Everything you need for a worry-free holiday — from one trusted team': (
        'كل ما تحتاجه لعطلة خالية من القلق — من فريق واحد موثوق',
    ...
    'Beaches, cities, honeymoons & group tours across the globe.': (
        'شواطئ، مدن، شهر عسل وجولات جماعية حول العالم.',
    ...
    "Looking for your dream vacation destination but don't know where to start? With the help of experienced and knowledgeable travel agents, you can plan the trip of a lifetime with ease.": (
        'تبحث عن وجهة عطلتك المثالية ولا تعرف من أين تبدأ؟ بمساعدة وكلاء سفر خبراء، يمكنك التخطيط لرحلة العمر بسهولة.',
    ...
    'City Walks Tour': ('جولة مشي في المدينة', 'Visite à pied de la ville'),
    'Discover iconic landmarks and hidden gems with expert local guides.': (
        'اكتشف المعالم الأيقونية والجواهر المخفية مع مرشدين محليين.',
        'Découvrez monuments emblématiques et trésors cachés avec des guides locaux.',
    ),
    'Sunset Boat Cruise': ('رحلة بحرية عند الغروب', 'Croisière au coucher du soleil'),
    'Relax on the water as the sun sets over breathtaking coastlines.': (
        'استرخِ على الماء بينما تغرب الشمس على سواحل خلابة.',
    ...
    'Immerse yourself in authentic traditions, cuisine, and heritage.': (
        'انغمس في التقاليد الأصيلة والمطبخ والتراث.',
    ...
    "Our customers' feedback is essential in building a great reputation and maintaining excellent service. By listening to our customers' needs, we improve our offerings and provide an exceptional travel experience.": (
        'ملاحظات عملائنا أساسية لبناء سمعة رائعة وتقديم خدمة ممتازة. بالاستماع لاحتياجاتهم، نحسّن عروضنا ونقدم تجربة سفر استثنائية.',
    ...
    'Ready to book your dream vacation?': ('مستعد لحجز عطلتك المثالية؟', 'Prêt à réserver vos vacances de rêve ?'),
    ...
    'WhatsApp Us': ('راسلنا على واتساب', 'Écrivez-nous sur WhatsApp'),
    ...
    'infant': ('رضيع', 'bébé'),
    'infants': ('رضع', 'bébés'),
    'From $%(amount)s': ('من %(amount)s$', 'À partir de %(amount)s $'),
